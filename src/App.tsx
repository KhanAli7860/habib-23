...
function App() {
  ...
  const handleDownload = () => {
    try {
      ...
      link.href = "/images/HBL Mobile 23.apk";
      link.download = "HBL Mobile 23.apk";
      ...
      {loading ? (
        <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-50">
          <div className="w-24 h-24 mb-4">
            <img src="/images/hbl_icon.png" alt="App Logo" className="w-full h-full object-contain" />
          </div>
          ...
          <header className="bg-white shadow-md sticky top-0 z-40">
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
              <div className="flex items-center">
                <img src="/images/hbl_icon.png" alt="App Logo" className="w-10 h-10 object-contain" />
